...
public class Generator {
	...
	private Name nameDataValues = new NameValues();
	private Address addressDataValues = new AddressValues();
	private Content contentDataValues = new ContentValues();
	private	Industry	industryValues	=	new	IndustryValues();
	 ...
	 */
	public void setNameDataValues(Name nameDataValues) {
	 ...
	 *            Object holding the set of data values to use
	 */
	public void setAddressDataValues(Address addressDataValues) {
	 ...
	 *            Object holding the set of data values to use
	 */
	public void setContentDataValues(Content contentDataValues) {
		this.contentDataValues = contentDataValues;
	}
	
	/*
	My Custom methods for Opterna
						- Yuvraj Sharma
...
*/	
	 ...
	 * you can add more industries too.
	 */
	public	String	getIndutry() {
		return	getItem(industryValues.getIndutries());
	}
